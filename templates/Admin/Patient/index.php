	...
	<div class="table-responsive">
		...
		?>
                <tr>
                    ...
                    <th><?= $this->Paginator->sort('patient_fullname') ?></th>
                    <th><?= $this->Paginator->sort('patient_icno') ?></th>
                    <th><?= $this->Paginator->sort('patient_gender') ?></th>
                    <th><?= $this->Paginator->sort('patient_notel') ?></th>
            ...
            <tbody>
				...
				<td><?php echo $counter++ ?></td>
                    ...
                    <td><?= h($patient->patient_icno) ?></td>
                    <td><?= h($patient->patient_gender) ?></td>
                    <td><?= h($patient->patient_notel) ?></td>
                    <td><?= h($patient->patient_email) ?></td>
                    <td><?= h($patient->patient_address) ?></td>
					...
					<td class="actions text-center">
						<div class="btn-group shadow" role="group" aria-label="Basic example">
							<?= $this->Html->link(__('<i class="far fa-folder-open"></i>'), ['action' => 'view', $patient->patient_id], ['class' => 'btn btn-outline-primary btn-xs', 'escapeTitle' => false]) ?>
							<?= $this->Html->link(__('<i class="fa-regular fa-pen-to-square"></i>'), ['action' => 'edit', $patient->patient_id], ['class' => 'btn btn-outline-warning btn-xs', 'escapeTitle' => false]) ?>
							...
							<?= $this->Form->postLink(
								...
								[
									'confirm' => __('Are you sure you want to delete Patient: "{0}"?', $patient->patient_id),
									'title' => __('Delete'),
...
<div class="card bg-body-tertiary border-0 shadow mb-4">
	<div class="card-body">
		<div class="card-title mb-0">Search</div>
			<div class="tricolor_line mb-3"></div>
			<?php echo $this->Form->create(null, ['valueSources' => 'query', 'url' => ['controller' => 'Patient','action' => 'index']]); ?>
				<fieldset>
