    ...
    <div class="px-0">
        <ul class="list-unstyled components">
            ...
            <li class="menu-header fw-bold text-uppercase mt-4 mb-3">
                        <span class="menu-header-text ps-4">Public</span>
            ...
            <?php if ($this->Identity->isLoggedIn()) { ?>
                ...
                <?php if ($this->Identity->isLoggedIn() && $this->Identity->get('user_group_id') == '1') { ?>
                    ...
                    <li class="menu-item <?= $c_name == 'Patient' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-hospital-user"></i> Patient Management'), ['controller' => 'Patient', 'action' => 'index', 'prefix' => false], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                    
                   <li class="menu-header fw-bold text-uppercase mt-4 mb-3">
                        <span class="menu-header-text ps-4">Clinic Management</span>
                        <div class="tricolor_line mb-3"></div>
                    </li>
                    <li class="menu-item <?= $c_name == 'Appointment' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-calendar-days"></i> Appointments'), ['prefix' => 'Admin', 'controller' => 'Appointment', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
                    <li class="menu-item <?= $c_name == 'Dentist' && $a_name == 'index' ? 'active' : '' ?>">
                        <?= $this->Html->link(__('<i class="menu-icon fa-solid fa-user-doctor"></i> Dentist Management'), ['prefix' => 'Admin', 'controller' => 'Dentist', 'action' => 'index'], ['class' => 'menu-link', 'escape' => false]) ?>
                    </li>
